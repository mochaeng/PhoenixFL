...
from ..neural_helper.mlp import PopoolaMLP, FnidsMLP, train, collect_metrics, load_data, DEVICE
...
if __name__ == "__main__":
    ...
    data, _ = get_standardized_data(df)
    ...
    print(f'\nTesting: {collect_metrics(model, test_loader)}')
